---
title: "Why Are the Vulnerable Always First in Line for Cuts? There Are Fairer Choices"
description: "A deep dive into the new welfare bill and its calculated, devastating impact on disabled and chronically ill people in the UK."
tags:
  - opinion
  - rights
  - politics
...
Let's talk about tax. Every year, the UK loses a staggering **£46.8 billion** to tax avoidance, evasion, and non-payment. That's not a typo. That's the official figure for 2023–24, published by HMRC ([GOV.UK Tax Gap Summary, 2025](https://www.gov.uk/government/statistics/measuring-tax-gaps/1-tax-gaps-summary)). If the government managed to close just 20% of that gap, it would bring in nearly **£9.5 billion**, more than enough to cover the so-called "savings" from welfare cuts.
...
- **Wealth Tax:** A modest 1% tax on individual wealth over £1 million could raise **£10 billion** a year, according to the independent [Wealth Tax Commission](https://www.ukwealth.tax/).
- **Fairer Capital Gains Tax:** If capital gains were taxed at the same rate as income, the Institute for Fiscal Studies estimates we'd see an extra **£8–14 billion** a year for public services ([IFS, 2020](https://ifs.org.uk/publications/14908)).
...
- **Cutting Waste:** Billions are lost every year to government inefficiency and dodgy contracts. The [National Audit Office](https://www.nao.org.uk/) regularly highlights areas where public money could be better spent.

And we do have to acknowledge the fact that benefit fraud and error cost the government about **£8.3 billion** last year ([Full Fact, citing DWP and HMRC](https://fullfact.org/online/benefit-fraud-tax-avoidance-losses/)). Note: that's NOT PIP fraud, which the DWP themselves say is non-existent. That's a lot, but it's still dwarfed by the tax gap. So why is the focus always on us?
...
- [HMRC Tax Gap Summary 2025](https://www.gov.uk/government/statistics/measuring-tax-gaps/1-tax-gaps-summary)
- [Wealth Tax Commission](https://www.ukwealth.tax/)
- [Institute for Fiscal Studies: Capital Gains Tax](https://ifs.org.uk/publications/14908)
- [Full Fact: Benefit Fraud vs Tax Avoidance](https://fullfact.org/online/benefit-fraud-tax-avoidance-losses/)
