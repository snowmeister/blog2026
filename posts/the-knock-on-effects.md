---
title: "The Ripple Effect: How Welfare Cuts Will Add Strain To The System"
description: "A look at the knock-on effects of the proposed welfare cuts."
tags:
  - opinion
  - rights
  - politics
...
When that support is cut, their ability to afford this care vanishes. They are then forced to turn to their local council for help. But here's the crunch: councils are already facing what the [Association of Directors of Adult Social Services (ADASS)](https://www.adass.org.uk/) consistently describes as a [funding crisis](https://healthcareleadernews.com/news/social-care-funding-crisis-revealed). They are being asked to do so much more, with so much less.
...
Medical leaders have been sounding the alarm on this for some time. A headline in the highly-respected [British Medical Journal (BMJ)](https://www.bmj.com/content/388/bmj.r562) warned, **"'Unprecedented' welfare cuts could pile demand on NHS, leaders warn."** This isn't speculation; it's a direct and predictable consequence.

This is where we see the devastating problem of "delayed discharges." Hospitals are full of patients who are medically fit to go home, but they are stuck in a hospital bed, not because they are sick, but because there is no safe social care package for them in the community. As the [Nuffield Trust report](https://www.nuffieldtrust.org.uk/resource/delayed-discharges-from-hospital) shows, this creates huge bottlenecks, reduces hospital capacity for new emergencies, and costs the NHS a fortune.

Last, but by no means least, direct link between poverty and poor health is undeniable. As [The Health Foundation](https://www.health.org.uk/features-and-opinion/blogs/welfare-reforms-risk-damaging-health-and-efforts-to-boost-employment) has highlighted, the financial hardship, stress, and anxiety caused by losing income can dramatically worsen existing mental and physical health conditions. This doesn't just increase GP appointments; it leads to more complex health needs that ultimately require more intensive and expensive hospital care.
...
Organisations like the [Joseph Rowntree Foundation (JRF)](https://www.jrf.org.uk/social-security/health-related-benefit-cuts-will-deliver-higher-poverty-not-employment) provide constant, sobering analysis of how these policies push more people into poverty. The shocking rise in food bank use is the most visible symptom of a system that is failing, with [The Trussell Trust](https://www.trusselltrust.org/news-and-blog/latest-stats/end-of-year-stats/) reporting nearly 3 million emergency food parcels distributed in a single year.
